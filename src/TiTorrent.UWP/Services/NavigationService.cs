    ...
    public class NavigationService
    {
        ...
        public bool Navigate(string pageKey, object parameter = null, NavigationTransitionInfo infoOverride = null)
        {
            ...
            lock (_pages)
            {
                ...
                {
                    throw new ArgumentException($"Invalid pageKey '{pageKey}', please provide a valid pageKey. Maybe you forgot to call NavigationService.Configure?", nameof(pageKey));
                }
            }
